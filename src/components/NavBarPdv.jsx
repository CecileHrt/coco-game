...
export default function NavBarPdv() {
  ...
  return (
    <header className="relative flex items-center justify-between p-2 bg-[var(--color-blanc-mauve)]">
      ...
      {menuOpen && (
        <div className="opacity-100 z-50 absolute top-14 h-[100vh] right-0 w-full bg-[#ede1f6]/70 p-4">
          <ul className="flex flex-col p-4 box-white-shadow space-y-2 mx-auto max-w-[480px]  ">
            ...
            <NavLink
              className={`hover:font-[600] hover:text-[var(--color-mauve-omb)] transition-all duration-500 ease-in-out hover:bg-[var(--color-mauve-pastel)] rounded w-full p-2 `}
              to="/coco-concept"
            >
              <li className="flex items-center ">
                <i className="text-[var(--color-mauve-omb)] mr-2 mb-0.5">
