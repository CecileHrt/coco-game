    ...
    <section className="space-y-4 mb-4 md:mb-6">
      ...
      <div className="flex align-baseline space-x-4 mb-12 pr-4">
        ...
        <div className="flex space-x-4 w-full max-sm:flex-col">
          ...
          <figure
            className="bg-[var(--color-noir)] self-end mb-1 rounded-t-sm h-1 mt-4 flex-grow w-full  
      ...
      <div className="flex justify-evenly items-center max-sm:flex-col ">
        ...
        >
          ...
          <label
            htmlFor="auteur"
            required
            className="mt-4 mb-1 md:text-lg font-[700]"
          >
            Présentez-vous :
          </label>
          <input
          ...
          <label htmlFor="avis" className="mt-4 mb-1 md:text-lg font-[700]">
            Donnez votre avis :
          </label>
          <textarea
            name="avis"
          ...
          <p className="text-sm md:text-sm mt-4 mb-4 ">
            ...
            <NavLink className="text-[var(--color-mauve-omb)] underline">
          ...
          <input
            ...
            className="cta text-lg my-4 w-full md:w-60 mx-auto pt-1 pb-2 md:text-xl bg-[var(--color-mauve-omb)] text-[var(--color-blanc-mauve)] border-[var(--color-mauve-omb)] hover:bg-[var(--color-mauve-omb)] hover:text-[var(--color-blanc-mauve)]"
          />
        </form>
      </div>
    </section>
