  ...
  return (
    <>
      ...
      <main>
        ...
        {/* SECTION 2 - Interface */}
        <section className="bg-[var(--color-blanc-mauve)] py-4 pl-4 lg:py-16 lg:pl-16">
          <div className="center">
            {/* TITRE */}
        ...
        <section className="bg-[var(--color-bleu-canard)] text-[var(--color-blanc-mauve)] p-4 lg:p-16">
          <div className="center">
            ...
            <div className="mx-auto w-70 xl:w-100 ">
              <NavLink
                to="/choix-coco"
                className="cta text-lg my-10 px-2 pt-2 pb-3 md:text-2xl hover:bg-[var(--color-bleu-canard)] hover:text-[var(--color-blanc-mauve)] border-[var(--color-bleu-canard)] bg-[var(--color-blanc-mauve)] text-[var(--color-bleu-canard)]"
              >
                Découvrir l'univers
              </NavLink>
            </div>
        ...
        {/* SECTION 4 - Pourquoi ?   */}
        <section className="bg-linear-[160deg] from-[#FFD8FA] via-[#C3A3FF] to-[#8964C2] p-4 lg:p-16">
          <div className="center">
            {/* TITRE */}
            <div className="flex align-baseline space-x-4 mb-12 pr-4">
              ...
              <div className="flex space-x-4 w-full max-sm:flex-col">
                ...
                <figure
                  className="bg-[var(--color-mauve-omb)] self-end mb-1 rounded-t-sm h-1 mt-4 flex-grow w-full  
              md:text-3xl md:mb-1 xl:mb-9 xl:text-4xl"
                ></figure>
              </div>
            </div>
        ...
        {/* SECTION 5 - Avis */}
        <section className="bg-[var(--color-mauve-pastel)] p-4 lg:p-16">
          <div className="center">
            <div className="flex align-baseline space-x-4 mb-8">
              ...
              <div className="flex space-x-4 w-full max-sm:flex-col">
                ...
                <figure
                  className="bg-red-500 self-end mb-1 rounded-t-sm h-1 mt-4 flex-grow w-full  
              md:text-3xl md:mb-1 xl:mb-9 xl:text-4xl"
                ></figure>
              </div>
            </div>
